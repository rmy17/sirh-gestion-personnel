	...
	<div class="container-fluid">
		<div class="row justify-content-end">
			<div class="col-ml-auto">
				<a href="creer-collab.html" class="btn btn-primary btn-lg active"
		...
		<div class="Container-fluid">
			<div class="col-4">
				<label class="my-1 mr-2" for="inlineFormCustomSelectPref">Filter
					par département :</label> <select
					class="custom-select my-1 mr-sm-2 float-center"
			...
			<div class="card-deck m-5">
				<c:forEach var="col" items="${listCollab}">
					...
					<div class="card border-secondary mb-3">
						<div class="card-header bg-transparent">${col.nom}
							${col.prenom}</div>
						<div class="row no-gutters">
							<img
								src="https://cdn.pixabay.com/photo/2017/01/25/17/33/camera-2008479_960_720.png"
